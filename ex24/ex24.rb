...
puts "We'd have %s beans, %d jars and %d crates" % secred_formula(start_point)

# What is <<END called?
# That is called a "heredoc" or "here document". 
# It is used to create a multi-line string, and you use it by starting with << and an all caps word, 
